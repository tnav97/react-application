...
export default function MotoCard(cardProps: CardProps) {
  ...
  useEffect(() => {
    if (footerProps.footerSectionProps.page === 'motoEmployee') {
    ...
    if (
      footerProps.footerSectionProps.page === 'motoCompanyType' &&
  ...
  useEffect(() => {
    if (selected !== companyTypeSelected.NOT_SELECTED) {
      if (footerProps.footerSectionProps.page === 'motoCompanyType') {
        dispatch({
